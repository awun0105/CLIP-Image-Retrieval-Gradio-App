...
| File | Purpose |
|---|---|
| [overview.md](overview.md) | Explains what the project is, what problem it solves, and what production-oriented MVP means. |
...
| [evaluation.md](evaluation.md) | Retrieval quality evaluation, benchmark tools, and how to interpret metrics. |
